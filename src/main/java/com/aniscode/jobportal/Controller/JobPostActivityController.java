...
import com.aniscode.jobportal.Services.JobSeekerApplyService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        //If the user ticks 30 days / 7 days / today, you set a cutoff date.
        //If none selected, dateSearchFlag=false (meaning “no date filter”).
        if (days30) {
        ...
        //If the user didn’t choose any of the type checkboxes,  default the search to all three types.
        ...
        //if the user didn’t pick any arrangement filter, you include all of them.
        ...
        //If no filters are applied, get all job posts.
        //Otherwise  call search() with the composed filters and date.
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            //else is a Job Seeker, show all job posts
            else {

                //1. Show jobs Job Seeker applied to (if any)
                //2. Show jobs Job Seeker save/bookmarked (if any)
                ...
                for (JobPostActivity jobActivity : jobPost) {
                    exist = false; //not confirm apply
                    saved = false; //not confirm save

                    //check jobSeekerApplyList
                    for (JobSeekerApply jobSeekerApply : jobSeekerApplyList) {
                        //if true, setActive true and stop loop
                    ...
                    //if true, setSaved true and stop loop
                    ...
                    //if not found in apply list, setActive false
                    if (!exist) {
                        jobActivity.setIsActive(false);
                    }
                    //if not found in save list, setSaved false
                    if (!saved) {
